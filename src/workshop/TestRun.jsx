...
export default function TestRun({project,onBack,resolveMedia,startIndex=0}) {
 const [index,setIndex]=useState(startIndex),[ended,setEnded]=useState(false),[ready,setReady]=useState(false),[sceneSteps,setSceneSteps]=useState({})
