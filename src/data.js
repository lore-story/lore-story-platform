...
export const stories = [
  { id: 'notruf-aus-dem-all', title: 'Notruf aus dem All', world: 'astra', subject: 'Klassenleitung', age: '9–13', duration: '45 Min.', chapters: 8, description: 'NOVA empfängt ein unbekanntes Signal. Registriert eure Crew und bereitet die Astra auf den Start vor.', skills: ['Gemeinschaft', 'Organisation'], accent: '#ff9d3b' },
