export const ASTRA_SCENES = Object.freeze([
  { id: 'ankunft', label: 'Szene 1 · Ankunft', title: 'Willkommen in der Crew-Akademie', message: 'Oh! Ihr seid also die neue Crew. Einen Moment … Meine Datenbank kennt euch noch nicht.', action: 'Mission starten', task: 'Hört NOVA zu und macht euch für die Registrierung bereit.' },
